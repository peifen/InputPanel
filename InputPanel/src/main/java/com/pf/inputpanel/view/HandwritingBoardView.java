package com.pf.inputpanel.view;
...
public class HandwritingBoardView extends View {
    ...
    private static final String TAG = HandwritingBoardView.class.getSimpleName();
    ...
    private float mPenSize = 10;// 画笔宽度 px
    private int mPenColor = Color.BLACK;// 画笔默认颜色
    private int mPanelColor = Color.TRANSPARENT;// 背景色（指最终签名结果文件的背景颜色，默认为透明色）
    private static final float TOUCH_TOLERANCE = 10;// 触点之间的公差，此变量用于控制，当路径在绘制过程中，移动距离至少等于10才绘制，减轻频繁的绘制的情况。
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        Log.e(TAG, "onSizeChanged getWidth() = " + getWidth() + ",getHeight() = " + getHeight() + ",oldw = " + oldw + ",oldh = " + oldh);
    }
